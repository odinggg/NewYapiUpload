package com.github.odinggg.newyapiupload.upload;

import com.github.odinggg.newyapiupload.constant.YapiConstant;
import com.github.odinggg.newyapiupload.dto.YapiCatMenuParam;
import com.github.odinggg.newyapiupload.dto.YapiCatResponse;
import com.github.odinggg.newyapiupload.dto.YapiHeaderDTO;
import com.github.odinggg.newyapiupload.dto.YapiInterfaceResponse;
import com.github.odinggg.newyapiupload.dto.YapiResponse;
import com.github.odinggg.newyapiupload.dto.YapiSaveParam;
import com.github.odinggg.newyapiupload.util.HttpClientUtil;
...
public class UploadYapi {
     ...
     * @return: com.github.odinggg.YapiResponse
     * @author: Hansen
     * @date: 2019/5/15
     */
    public YapiResponse uploadSave(YapiSaveParam yapiSaveParam, String attachUpload, String path) throws IOException {
        ...
        if (yapiResponse.getErrcode() == 0) {
            String response = HttpClientUtil.ObjectToString(HttpClientUtil.getHttpclient()
                    .execute(this.getHttpPost(yapiSaveParam.getYapiUrl() + YapiConstant.yapiSave, gson.toJson(yapiSaveParam))), "utf-8");
    ...
    public void changeDesByPath(YapiSaveParam yapiSaveParam) {
        try {
            String response = HttpClientUtil.ObjectToString(HttpClientUtil.getHttpclient()
                    .execute(this.getHttpGet(yapiSaveParam.getYapiUrl() + YapiConstant.yapiGetByPath + "?token=" + yapiSaveParam
                            .getToken() + "&path=" + yapiSaveParam.getPath())), "utf-8");
    ...
    public YapiResponse getCatIdOrCreate(YapiSaveParam yapiSaveParam) {
        ...
        try {
            response = HttpClientUtil.ObjectToString(HttpClientUtil.getHttpclient()
                    .execute(this.getHttpGet(yapiSaveParam.getYapiUrl() + YapiConstant.yapiCatMenu + "?project_id=" + yapiSaveParam
    ...
    private Integer addMenu(YapiSaveParam yapiSaveParam, Integer parent_id, String menu) throws IOException {
        ...
        String responseCat = HttpClientUtil.ObjectToString(HttpClientUtil.getHttpclient()
                .execute(this.getHttpPost(yapiSaveParam.getYapiUrl() + YapiConstant.yapiAddCat, gson.toJson(yapiCatMenuParam))), "utf-8");
        YapiCatResponse yapiCatResponse = gson.fromJson(gson.fromJson(responseCat, YapiResponse.class)
                .getData()
                .toString(), YapiCatResponse.class);
